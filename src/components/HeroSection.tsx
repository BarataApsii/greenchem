...
export function HeroSection({ 
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center py-16 sm:py-0">
      ...
      {/* --- Content START --- */}
      <div className="relative z-10 w-full flex flex-col items-center justify-center px-4 pt-48 pb-24 sm:pt-64">
        <div className="w-full max-w-4xl mx-auto text-center">
          {/* Text Content with Semi-Transparent Background */}
            <div className="bg-black/40 inline-block px-6 py-4 sm:px-8 sm:py-6 rounded-lg mb-8 sm:mb-10 md:mb-12">
          ...
          {/* --- CTA Buttons START --- */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 justify-center items-center w-full max-w-xs sm:max-w-md mx-auto">
            <a 
              href={ctaLink}
