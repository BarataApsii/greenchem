...
const ConstructionSection = () => {
  ...
  return (
    <div className="h-full border-2 border-amber-200 bg-amber-50 rounded-xl overflow-hidden flex flex-col">
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <ul className="space-y-3 mb-6">
          {service.features.map((feature, index) => (
            <li key={index} className="flex items-start">
              <span className="inline-block w-2 h-2 rounded-full mt-2 mr-2 bg-amber-700 flex-shrink-0"></span>
        ...
        <div className="mt-auto pt-4 border-t border-gray-100">
          <button 
            className="w-full py-2 bg-amber-600 text-white rounded-lg font-medium hover:bg-amber-700 transition-colors duration-200"
            onClick={() => {
