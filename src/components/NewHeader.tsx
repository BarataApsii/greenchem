      ...
      <header className="fixed top-0 left-0 w-full z-50 border-b border-primary/20 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Temporary: Force show navigation for testing */}
            <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
              <Link to="/" className="text-gray-900 hover:text-primary px-3 py-2 text-base font-medium">
                Home
              </Link>
              <a href="#about" className="text-gray-900 hover:text-primary px-3 py-2 text-base font-medium">
                About Us
              </a>
              <a href="#services" className="text-gray-900 hover:text-primary px-3 py-2 text-base font-medium">
                Services
              </a>
              <Link to="/gallery" className="text-gray-900 hover:text-primary px-3 py-2 text-base font-medium">
                Gallery
              </Link>
              <a href="#contact" className="ml-4 bg-primary text-white hover:bg-primary/90 px-6 py-2 rounded-md font-medium">
                Contact Us
              </a>
            </div>
